...
app = Flask(__name__)
app.secret_key = '151209'

app.config['MAIL_SERVER'] = 'smtp.ukr.net'
app.config['MAIL_PORT'] = 465
app.config['MAIL_USE_TLS'] = False
app.config['MAIL_USE_SSL'] = True
app.config['MAIL_USERNAME'] = 'kulchytska.sofiia@ukr.net'
app.config['MAIL_PASSWORD'] = 'aYj1Wp72g7edVi2V'
app.config['MAIL_DEFAULT_SENDER'] = 'kulchytska.sofiia@ukr.net'
...
def book(sub_service_id):
    ...
    if request.method == 'POST':
        ...
        if user:
            ...
            body = f"Дякуємо за запис на '{sub_service['name']}'! Майстер: {random.choice(masters)}, Дата та час: {date_time}"
